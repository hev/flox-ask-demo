...
Tokens generated with `flox auth token` are associated with your user account and will expire 1 month from when they were issued. For a more robust alternative see [Machine Access Tokens for Organizations](/docs/concepts/organizations#machine-access-tokens).
...
See the [`options.activate.mode`](/docs/man/manifesttoml#options) option in the manifest for more details on modes.
...
[intro]: /docs/imageless-kubernetes/intro
[floxhub]: /docs/concepts/floxhub
[flox_auth]: /docs/man/flox-auth
