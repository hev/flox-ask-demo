...
- You can `flox pull --copy` an environment to [use it as a template for a new project](/docs/tutorials/composition#creating-a-template-for-new-projects).
- You can use it directly in other environments by [adding it to another environment's `[include]` section](/docs/tutorials/composition#composing-environments).
- You can use it to share software across multiple machines, most commonly with a default environment, by [adding it to your terminal's RC files](/docs/tutorials/default-environment#initial-setup).
...
[multi_arch_guide]: /docs/tutorials/multi-arch-environments
...
[flox_containerize]: /docs/man/flox-containerize
