...
[base-catalog]: /docs/concepts/base-catalog
[nix-expression-builds]: /docs/concepts/nix-expression-builds
[flox-publish]: /docs/man/flox-publish
[publishing-concept]: /docs/concepts/publishing
[extensions-example]: /docs/concepts/nix-expression-builds#example-extensions-of-an-existing-package
[patches-example]: /docs/concepts/nix-expression-builds#example-patches-to-an-existing-package
[vendor-example]: /docs/concepts/nix-expression-builds#example-vendor-an-existing-package
[build-and-publish]: /docs/tutorials/build-and-publish
