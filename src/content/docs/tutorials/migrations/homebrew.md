...
[default_tutorial]: /docs/tutorials/default-environment
[default_tutorial_setup]: /docs/tutorials/default-environment#initial-setup
[creating_tutorial]: /docs/tutorials/creating-environments
[install_flox]: /docs/install-flox/install
[search]: /docs/man/flox-search
[envs]: /docs/man/flox-envs
[list]: /docs/man/flox-list
[catalog]: /docs/concepts/packages-and-catalog
[install]: /docs/man/flox-install
[uninstall]: /docs/man/flox-uninstall
