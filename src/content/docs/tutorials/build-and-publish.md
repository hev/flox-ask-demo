...
[flox-manifest-build-section]: /docs/man/manifesttoml#build
[build-concept]: /docs/concepts/builds
...
[extra-builds]: /docs/concepts/manifest-builds#example-configuration-files
