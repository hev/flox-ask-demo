---
title: "manifest.toml"
description: "manifest.toml - declarative environment configuration format"
group: "Manual"
order: 94
---
...
- [`[build]`](#build)
- [`[options]`](#options)
- [`containerize`] - see [`flox-containerize(1)`](/docs/man/flox-containerize)
...
or interactively via [`flox-edit(1)`](/docs/man/flox-edit).
...
See [`flox-upgrade(1)`](/docs/man/flox-upgrade) for more details on how
...
[`flox init`](/docs/man/flox-init) automatically populates this list with the
current system type.
...
system to this list.
See [`flox-pull(1)`](/docs/man/flox-pull) for more details.
