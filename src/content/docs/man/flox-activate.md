---
title: "flox activate"
description: "flox-activate - activate environments"
group: "Manual"
order: 61
---
...
hook was defined.
See [`manifest.toml(5)`](/docs/man/manifesttoml) for more details on shell hooks.

To reverse activation,
run [`flox-deactivate(1)`](/docs/man/flox-deactivate).
...
See [`manifest.toml(5)`](/docs/man/manifesttoml) for more details on activation
modes.
...
## SEE ALSO
[`flox-deactivate(1)`](/docs/man/flox-deactivate),
