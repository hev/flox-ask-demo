---
title: "flox install"
description: "flox-install - install packages to an environment"
group: "Manual"
order: 80
---
...
See [`manifest.toml(5)`](/docs/man/manifesttoml) for more details on the available
options.
...
See [`manifest.toml(5)`](/docs/man/manifesttoml) for more details.
