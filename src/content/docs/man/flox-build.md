---
title: "flox build"
description: "flox-build - Build packages with Flox"
group: "Manual"
order: 66
---
...
See [`flox-build-update-catalogs(1)`](/docs/man/flox-build-update-catalogs)
and [`nix-builds.toml(5)`](/docs/man/nix-buildstoml) for details.
...
[`flox-build-clean(1)`](/docs/man/flox-build-clean)
[`flox-build-import-nixpkgs(1)`](/docs/man/flox-build-import-nixpkgs)
[`flox-build-update-catalogs(1)`](/docs/man/flox-build-update-catalogs)
