...
See [Activating environments](/docs/concepts/activation) for more about hooks.
...
- [`manifest.toml` reference](/docs/man/manifesttoml) — `[hook]` section
- [Activating environments](/docs/concepts/activation) — how hooks work
