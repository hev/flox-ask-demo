...
description: "Containers are everywhere these days. They're the de-facto deployment method in the industry, and they're often used for local development as well to ensure tha"
group: "Concepts"
order: 49
---
...
[containerize]: /docs/man/flox-containerize
[activate]: /docs/man/flox-activate
[services-start]: /docs/man/flox-services-start
[services]: /docs/concepts/services
[manifest]: /docs/concepts/environments#manifesttoml
[builds]: /docs/concepts/builds
[ci-cd]: /docs/tutorials/ci-cd
