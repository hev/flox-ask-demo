...
See the [`options.activate.mode`](/docs/man/manifesttoml#options) option in the manifest.
...
[environment-concept]: /docs/concepts/services
[bash-func-export]: https://www.gnu.org/software/bash/manual/html_node/Bourne-Shell-Builtins.html#index-export
[vars-section]: /docs/man/manifesttoml#vars
[hook-section]: /docs/man/manifesttoml#hook
[profile-section]: /docs/man/manifesttoml#profile
