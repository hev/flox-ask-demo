...
[manifest-reference]: /docs/man/manifesttoml#build
[services-concept]: /docs/concepts/services
[publish-concept]: /docs/concepts/publishing
[fhs-docs]: https://en.wikipedia.org/wiki/Filesystem_Hierarchy_Standard
[pkg-groups]: /docs/man/manifesttoml#package-descriptors
[grpc]: https://grpc.io/
[organizations-concept]: /docs/concepts/organizations
[go-example]: /docs/languages/go#build-with-flox
